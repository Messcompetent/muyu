...
import com.example.xr.muyudemo.video.test_webview_demo.utils.X5WebView;
...
public class CrowserActivity extends Activity {
	/**
	...
	private void init() {
		...
		mWebView.setDownloadListener(new DownloadListener() {
			...
			public void onDownloadStart(String arg0, String arg1, String arg2,
				...
				new AlertDialog.Builder(CrowserActivity.this)
...
//		}
	...
	private void initBtnListenser() {
		...
		mMore.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Toast.makeText(CrowserActivity.this, "not completed",

 ...
 *
 */
public class Bvideo extends Activity {
...
//    private String url = "http://look.appjx.cn/mobile_api.php?mod=news&id=12604";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bvideo);
        initwidget();
        initListener();
        videowebview.loadUrl(bofangdeurl);
    }
...
//				setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        public View getVideoLoadingProgressView() {
            ...
            if (xprogressvideo == null) {
                LayoutInflater inflater = LayoutInflater.from(Bvideo.this);
